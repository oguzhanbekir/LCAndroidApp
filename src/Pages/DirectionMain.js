...
const firstSwiperText = 'Türkiye\'nin ilk nefis kenar pizzasının mucidi Little Caesars\'ın Android uygulaması'
const secondSwiperTitle = 'Hızlı Üyelik'
const secondSwiperText = 'Kolayca profilini oluşturup, dilediğin Sezar lezzetine ulaşabilirsin'
const thirdSwiperTitle = 'Kolay Sipariş'
const thirdSwiperText = 'İster son siparişini ister önceki siparişlerini tekrar ederek kolayca sipariş verebilirsin'
    ...
    render() {
        return (
            <View style={styles.container}>
                <Image
                    resizeMode='contain'
                    style={{ height: 150, width: '100%',marginBottom:100 }}
                    source={require('../images/lc_directionPage.png')}
                />
                <View style={styles.wrapper} >
                    <Swiper 
                        activeDot={<View style={{backgroundColor: 'gray', width: 10, height: 10, borderRadius: 5, marginLeft: 3, marginRight: 3, marginTop: 3, marginBottom: 3,}} />}
                    >
